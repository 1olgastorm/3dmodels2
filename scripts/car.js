...
/**
 *  Car class
    ref car 2D physics : https://github.com/spacejack/carphysics2d
...
Car.Config = function( opts )
{
	...
	this.wheelRadius = opts.wheelRadius || 0.5;  // Includes tire (also represents height of axle)
	this.wheelWidth = opts.wheelWidth || 0.4;  // Used for render only
